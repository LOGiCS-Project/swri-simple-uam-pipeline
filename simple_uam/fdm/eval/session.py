    ...
    def write_exception(self,
        ...
        try:
            ...
            output = textwrap.dedent(
                """
                Caught error when performing operation:
                ...
                The full error, including extant local variables and
                additional data can be found in `metadata.json`.
                """
            ).format(
                textwrap.indent(context, '    '),
                textwrap.indent(err_msg, '    '),
            )
